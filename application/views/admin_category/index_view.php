<div id="content-box">
	<div id="langbutton">
		<div id="titletext"><h2>Category List:</h2></div>
...
?>
		<tr>
			...
			<td><?php echo substr( $obj->category_description, 0, 65 ) . " ..."; ?></td>
...
else echo "<tr><td colspan='7' class='td_center'><a href='$url/add'>Please add a category first.</a></td></tr>";
?>
</table>
